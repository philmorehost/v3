...
<div style="text-align: left; overflow: auto;" class="container-box color-8 bg-4 mobile-width-90 system-width-90 mobile-margin-top-2 system-margin-top-2 mobile-padding-top-2 system-padding-top-2 mobile-padding-right-2 system-padding-right-2 mobile-padding-left-2 system-padding-left-2 mobile-padding-bottom-2 system-padding-bottom-2">
	...
	<span class="mobile-font-size-12 system-font-size-14">
		...
		<div class="scrollable-div" style="display:inline-block; padding:5px 2px 5px 2px; border-radius:5px; border:1px solid var(--color-8); font-weight:bold;"><?php echo $w_host; ?>/api/datacard.php</div><br>
		...
		<div class="scrollable-div" style="display:inline-block; padding:5px 2px 5px 2px; border-radius:5px; border:1px solid var(--color-8); font-weight:bold;">
			<cite><?php echo $w_host; ?>/api/datacard.php?token=gw18ys5tfw&network=mtn&size=1.5gb&qty=4</cite>
		</div><br>
		...
		<cite><b>Available Service and Their Sizes</b></cite><br>
		<b>MTN:</b> 1.5gb<br>
		<b>AIRTEL:</b> null<br>
		<b>GLO:</b> null<br>
		<b>9MOBILE:</b> null
	...
	<?php
		//GET EACH datacard API DISCOUNT
	...
	<div class="scrollable-div">
		<table class="table-style-1 table-font-size-1">
			...
			<tr>
				<td>MTN</td><td><?php echo $get_mtn_datacard_running_api["discount_1"]; ?></td><td><?php echo $get_mtn_datacard_running_api["discount_2"]; ?></td><td><?php echo $get_mtn_datacard_running_api["discount_3"]; ?></td><td><?php echo $get_mtn_datacard_running_api["discount_4"]; ?></td>
			</tr>
			<tr>
				<td>Airtel</td><td><?php echo $get_airtel_datacard_running_api["discount_1"]; ?></td><td><?php echo $get_airtel_datacard_running_api["discount_2"]; ?></td><td><?php echo $get_airtel_datacard_running_api["discount_3"]; ?></td><td><?php echo $get_airtel_datacard_running_api["discount_4"]; ?></td>
			</tr>
			<tr>
				<td>GLO</td><td><?php echo $get_glo_datacard_running_api["discount_1"]; ?></td><td><?php echo $get_glo_datacard_running_api["discount_2"]; ?></td><td><?php echo $get_glo_datacard_running_api["discount_3"]; ?></td><td><?php echo $get_glo_datacard_running_api["discount_4"]; ?></td>
			</tr>
			<tr>
				<td>9mobile</td><td><?php echo $get_9mobile_datacard_running_api["discount_1"]; ?></td><td><?php echo $get_9mobile_datacard_running_api["discount_2"]; ?></td><td><?php echo $get_9mobile_datacard_running_api["discount_3"]; ?></td><td><?php echo $get_9mobile_datacard_running_api["discount_4"]; ?></td>
			</tr>
