	...
	if(!empty($api_token) && !empty($api_network) && !empty($api_data_qty) && !empty($api_phone_number)){
		...
		if(mysqli_num_rows($token_owner_details) == 1){
			if(in_array($api_network,array("mtn","airtel","glo","9mobile"))){
					...
					$get_mtn_gifting_data_network_qty_price = mysqli_query($conn_server_db, "SELECT gifting_data_qty, gifting_data_price_1, gifting_data_price_2, gifting_data_price_3, gifting_data_price_4 FROM mtn_gifting_data_network_qty_price WHERE gifting_data_qty='$api_data_qty'");
					$get_airtel_gifting_data_network_qty_price = mysqli_query($conn_server_db, "SELECT gifting_data_qty, gifting_data_price_1, gifting_data_price_2, gifting_data_price_3, gifting_data_price_4 FROM airtel_gifting_data_network_qty_price WHERE gifting_data_qty='$api_data_qty'");
					$get_glo_gifting_data_network_qty_price = mysqli_query($conn_server_db, "SELECT gifting_data_qty, gifting_data_price_1, gifting_data_price_2, gifting_data_price_3, gifting_data_price_4 FROM glo_gifting_data_network_qty_price WHERE gifting_data_qty='$api_data_qty'");
					$get_9mobile_gifting_data_network_qty_price = mysqli_query($conn_server_db, "SELECT gifting_data_qty, gifting_data_price_1, gifting_data_price_2, gifting_data_price_3, gifting_data_price_4 FROM etisalat_gifting_data_network_qty_price WHERE gifting_data_qty='$api_data_qty'");
					...
					$amount = mysqli_fetch_assoc($get_mtn_gifting_data_network_qty_price)["gifting_data_price_4"];
					$check_data_qty_exist = $get_mtn_gifting_data_network_qty_price;
					$network_state = $get_mtn_gifting_data_network_status["network_status"];
					}
					
					if($api_network == "airtel"){
					$apikey = $get_airtel_gifting_data_apikey["apikey"];
					$site_name = $airtel_api_website;
					$amount = mysqli_fetch_assoc($get_airtel_gifting_data_network_qty_price)["gifting_data_price_4"];
					$check_data_qty_exist = $get_airtel_gifting_data_network_qty_price;
					$network_state = $get_airtel_gifting_data_network_status["network_status"];
					}
					
					if($api_network == "glo"){
					$apikey = $get_glo_gifting_data_apikey["apikey"];
					$site_name = $glo_api_website;
					$amount = mysqli_fetch_assoc($get_glo_gifting_data_network_qty_price)["gifting_data_price_4"];
					$check_data_qty_exist = $get_glo_gifting_data_network_qty_price;
					$network_state = $get_glo_gifting_data_network_status["network_status"];
					}
					
					if($api_network == "9mobile"){
					$apikey = $get_9mobile_gifting_data_apikey["apikey"];
					$site_name = $etisalat_api_website;
					$amount = mysqli_fetch_assoc($get_9mobile_gifting_data_network_qty_price)["gifting_data_price_4"];
					$check_data_qty_exist = $get_9mobile_gifting_data_network_qty_price;
					$network_state = $get_9mobile_gifting_data_network_status["network_status"];
					}
					if(mysqli_num_rows($check_data_qty_exist) == 1){
						...
						if($token_owner_details_array["wallet_balance"] >= $amount){
							if($site_name == "rpidatang.com"){
								include("./../include/gifting-data-rpidatang.php");
