...
<form method="get" action="/admin/site-setting.php">
	...
	<input name="search" type="text" class="input-box mobile-width-35 system-width-30" placeholder="Search by: Reference, Meter No"> <button id="" class="button-box color-8 bg-6 mobile-font-size-13 system-font-size-16 mobile-width-20 system-width-15">Search</button>
