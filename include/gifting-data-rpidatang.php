...
if ($daily_transaction_counter["status"] == true) {
	...
	if (mysqli_num_rows($check_blocked_number_before_recharge) === 0) {
		if ($carrier == "mtn") {
			$net_id = 1;
			$data_gifting_array_prices = array("500mb" => "208", "1gb" => "209", "2gb" => "210", "3gb" => "211", "5gb" => "212", "10gb" => "220", "15gb" => "221", "20gb" => "222");
		}

		if ($carrier == "airtel") {
			$net_id = 4;
			$data_gifting_array_prices = array("300mb" => "239", "500mb" => "232", "1gb" => "233", "2gb" => "234", "5gb" => "235", "10gb" => "150");
		}

		if ($carrier == "glo") {
			$net_id = 2;
			$data_gifting_array_prices = array("500mb" => "270", "1.0gb" => "271", "2.0gb" => "272", "3.0gb" => "273", "5gb" => "274", "10gb" => "275");
		}

		if ($carrier == "9mobile") {
			$net_id = 3;
			$data_gifting_array_prices = array("500mb" => "276", "1gb" => "278", "2gb" => "280", "3gb" => "281", "5gb" => "283", "10gb" => "284", "15gb" => "285", "20gb" => "286", "40gb" => "287");
		}
		...
		if (!empty($data_gifting_array_prices[$data_qty])) {
			...
			if ($wallet_balance >= $amount) {
				...
				$dataApiUrl = "https://www.rpidatang.com/api/data/";
